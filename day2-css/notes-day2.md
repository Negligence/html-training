...
```html
  ...
  <h6 title="h6">Heading 6</h6>

  <a href="https://www.coingecko.com/" target="_blank" rel="noopener noreferrer">Coin Gecko</a>

  <a href="https://www.binance.com/en" target="_blank" rel="noopener noreferrer">Binance</a>
  
  <!-- ul>li*3>a{Head Link}+ol>li*3>a{Sublink} -->
  <ul>
    <li>
      <a href="#">Head Link</a>
      <ol>
...
a:focus {outline: 3px dotted plum;}
...
```html
  <section>
    ...
    <!-- <iframe id="ytplayer" type="text/html" width="1920" height="1080" src="https://www.youtube.com/embed/DSKOg3KpTic?autoplay=1&mute=1&controls=0&disablekb=1&enablejsapi=1&fs=0&loop=1&modestbranding=1&color=white" frameborder="0" allowfullscreen></iframe> -->
    <a href="#">Shop</a>
  </section>
```
